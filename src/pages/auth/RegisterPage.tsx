...
const RegisterPage = () => {
  ...
  const onSubmit = async ({ full_name, email, password }: FormValues) => {
      ...
      >
        {done ? (
          <div className="flex flex-col items-center text-center gap-5 py-6">
            ...
            <h2 className="font-cabinet font-black text-3xl uppercase text-bitter-liquorice">Check your email</h2>
            ...
            <Link
              to="/login"
              className="mt-2 font-cabinet font-bold text-sm text-bitter-liquorice/50 hover:text-bitter-liquorice transition-colors underline underline-offset-2"
            >
              Back to Sign In
            </Link>
          </div>
          ...
          <>
            <div className="text-center mb-8">
              ...
              <p className="font-general text-bitter-liquorice/60 mt-1">Sunday Life Staff Portal</p>
            </div>

            <form onSubmit={handleSubmit(onSubmit)} noValidate className="flex flex-col gap-4">
              <Field id="full_name" label="Full Name" type="text" placeholder="Jane Doe"
                registration={register('full_name')} error={errors.full_name?.message} />
              <Field id="email" label="Email" type="email" placeholder="you@sundaylife.org"
