  ...
  return (
    <footer className="bg-bitter-liquorice border-t border-waxy-corn/20 py-12 text-pink-swirl text-center">
      <div className="max-w-7xl mx-auto px-6 flex flex-col items-center">
        ...
        <p className="font-general text-sm text-pink-swirl/60 mb-8 max-w-sm">
        ...
        <p className="font-general text-xs text-pink-swirl/40 pt-8 border-t border-waxy-corn/10 w-full">
